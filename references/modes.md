...
9. write their documented logs and output files (for iterating modes this includes `research-results.tsv`, `autoresearch-lessons.md`, and `autoresearch-state.json` -- none committed to git),

...
from autoresearch_hook_context import find_repo_root, load_hook_context_pointer
...
SKILL_ROOT_RELATIVE_CANDIDATES = (
    Path(".agents/skills/codex-autoresearch/autoresearch"),
    Path(".codex/skills/codex-autoresearch/autoresearch"),
)
